...
To handle authentication, openEO leverages [OpenID Connect (OIDC)](OpenID Connect (OIDC)). It offers some interesting features (e.g. a user can securely reuse an existing account), but is a fairly complex topic, discussed in more depth in the [general authentication documentation for openEO Platform](general authentication documentation for openEO Platform).
...
client_id = "request at openeo platform support" 
secret = "request at openeo platform support" 
